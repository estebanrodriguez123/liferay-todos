...
public class TaskLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return TaskLocalServiceUtil.addTask((com.rivetlogic.portlet.todo.model.Task)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return TaskLocalServiceUtil.deleteTask((com.rivetlogic.portlet.todo.model.Task)arguments[0]);
		}
